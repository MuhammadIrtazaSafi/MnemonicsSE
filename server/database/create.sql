...
CREATE TABLE mnemonics (mn_id SERIAL PRIMARY KEY, word_id FOREIGN KEY(word_id), user_id FOREIGN KEY(user_id), mnemonic VARCHAR(200) NOT NULL, lat DECIMAL, long DECIMAL, rating INTEGER);
